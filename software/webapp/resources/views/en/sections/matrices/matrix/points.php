<section id="pts">
    <div class="row align-items-center g-2">
        <h1 class="col-md border-bottom pb-1 mb-0">Registered points</h1>
        <?php 
    ...
    <form class="row mb-3 collapse" action="/app/api.php" method="POST" id="form-np">
            <div class="input-group w-75">
                <label class="form-control bg-secondary text-white">New point</label>
    ...
    <div class="row g-5">
            <div class="col">
                <table class="table border table-hover table-points-grid align-middle">
                        ...
                        <tr>
                            ...
                            <th>
                                <div class="d-flex align-items-center justify-content-between gap-2">
                                    <span>Status</span>
                                    <div class="status-filter-icon-wrap" title="Filter by status">
                                        <svg class="bi status-filter-icon" width="16" height="16" aria-hidden="true"><use xlink:href="#funnel"/></svg>
                                        <select id="pointsStatusFilter" class="status-filter-icon-select" aria-label="Filter by status">
                    ...
                    <tbody id="tablePts">
                        <tr>
                            <td colspan="5" class="text-center">No registered points found</td>
                        </tr>
                    </tbody>
                </table>
            </div>
